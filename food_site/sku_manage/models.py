...
class SKU(models.Model):
    ...
    case_upc = models.DecimalField(max_digits=12, decimal_places=0, unique=True, validators=[validate_upc],
    ...
    def get_serializable_string_array(self):
        return [str(self.sku_num), self.name, str(self.case_upc), str(self.unit_upc), self.unit_size,
                str(self.units_per_case), self.product_line.name, self.comment]
