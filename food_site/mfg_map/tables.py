...
class SKUTable(tables.Table):
	...
	add_colunm = tables.TemplateColumn(orderable=False, verbose_name="Add", template_name='mfg_map/addcolumn.html')
	class Meta:
		model = SKU
		fields = ['name', 'sku_num']
...
class SelectedTable(tables.Table):
	lines_column = tables.TemplateColumn(order_by='skumfgline', verbose_name="Manufacturing Lines", template_name='mfg_map/linecolumn.html')
	remove_colunm = tables.TemplateColumn(orderable=False, verbose_name="Remove", template_name='mfg_map/remcolumn.html')
	class Meta:
		model = SKU
		fields = ['name', 'sku_num']
